...
const ContraseniaConfirm = ({route, navigation}) => {
  ...
  Email:email.usuario.Email}
    ...
    return (
        <KeyboardAwareScrollView style={{flex:1,alignContent: "center",  backgroundColor: "#1f1b36", padding:15, flexDirection:'column'}}>
            <StatusBar/>
            <H2 h2='Contraseña'></H2>
            <Subtitle Text={'Crea una contraseña con mínimo 8 caracteres.'}/>
        <IptContrasenia
...
export default ContraseniaConfirm
